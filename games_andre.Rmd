...
```{r}
ggplot(gaming_no_na,aes(x="global_sales",y= "publisher",top_n(10))) + 
...
```{r}
ggplot(gaming_no_na,aes(x=year_of_release,y=name)) + geom_line()
```
...
```{r}
ggplot(gaming_no_na, aes(x=global_sales, y=genre)) + geom_bar(stat="identity", fill="yellow")
```
