...
ggplot(games_per_year,aes(x=year_of_release,y=game_per_year)) + geom_line()

saveRDS(games_per_year, "games_per_year.rds")
```
...
```{r}
ggplot(gaming_no_na,aes(x=global_sales,y=publisher,top_n(10))) + geom_line()
...
```{r}
ggplot(gaming_no_na,aes(x=global_sales,y=)) + geom_bar(stat="identity", fill="green")
```
