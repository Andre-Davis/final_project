...
install.packages(c("tidyverse","janitor", "ggplot2","gridExtra"))
library(tidyverse)
library(janitor)
library(ggplot2)
library(gridExtra)
...
ggplot(games_per_year,aes(x=as.numeric(year_of_release),y=game_per_year)) + geom_line()
...
ggplot(top_companies,aes(x=as.numeric(year_of_release),y=total_sales,group=publisher,color=publisher)) + geom_line()
...
ggplot(world_sales, aes(x=reorder(genre,sales), y=sales)) + geom_bar(stat="identity", fill="yellow")
```
...
na<-ggplot(regional_sales, aes(x=reorder(genre,sales_na), y=sales_na)) + geom_bar(stat="identity", fill="yellow")

eu<-ggplot(regional_sales, aes(x=reorder(genre,sales_eu), y=sales_eu)) + geom_bar(stat="identity", fill="yellow")

jp<-ggplot(regional_sales, aes(x=reorder(genre,sales_jp), y=sales_jp)) + geom_bar(stat="identity", fill="yellow")
